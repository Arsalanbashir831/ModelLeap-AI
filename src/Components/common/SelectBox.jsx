...
import { Menu, MenuButton, MenuList, MenuItem, Button, Badge, Flex, Text, Box } from '@chakra-ui/react';
          ...
          >
            <Flex gap={4} align="center" overflow="hidden">
              <Text 
                ...
                maxW="80%" // Adjust this to control truncation width
              >
                ...
                {group.options.map((option) => (
                  ...
                  >
                    <Flex align="center" justify="space-between" width="100%">
                      <Text color={theme.textColor} fontSize="sm" fontWeight="normal" isTruncated>
                        {option.label}
                      </Text>
                      {option.isPro && (
                        <Badge ml="auto" bg={badgeBg} color="white" borderRadius="md" px="2" py="1" fontSize="xs">
